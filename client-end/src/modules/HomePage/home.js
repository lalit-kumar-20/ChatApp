		...
		<div className='w-screen flex'>
			<div className='w-[25%] h-screen bg-secondary overflow-scroll '>
				<div className='flex items-center justify-center my-20'>
					<div><img src={testimg} width={75} height={75}  className='border border-primary p-[2px] rounded-full' /></div>
					<div className='flex'>
						<h3 className='text-2xl'>{user?.fullName}</h3>
						<p className='text-lg font-light mx-1'>My Account</p>
					</div>
				</div>
				<hr />
				<div className='mt-10'>
					<div className='flex items-center justify-center text-primary text-lg'>Messages</div>
					<div>
						{
							conversations.length > 0 ?
								...
								}) : <div className='flex items-center justify-center text-center text-lg font-semibold mt-24'>No Conversations</div>
						}
					</div>
				</div>
			</div>
			...
			<div className='w-[25%] h-screen bg-dark px-8 py-16 overflow-scroll'>
				<div className='flex items-center justify-center text-primary text-lg'>People</div>
				<div>
					{
						users.length > 0 ?
